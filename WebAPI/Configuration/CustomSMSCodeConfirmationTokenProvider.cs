...
{
    public class CustomSMSCodeConfirmationTokenProvider : PhoneNumberTokenProvider<User>
    {
    ...
    public class SMSConfirmationTokenProviderOptions : DataProtectionTokenProviderOptions
    {
        public SMSConfirmationTokenProviderOptions()
        {
            Name = "SMSDataProtectorTokenProvider";
